...
#plot on plot1.png file (not default output)
png(filename = "plot1.png", width = 480, height = 480, units = "px")
hist(power_data_clean$Global_active_power, col="red", main="Global Active Power", xlab="Global Active Power (kilowatts)")
dev.off()
